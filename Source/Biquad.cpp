...
void Biquad2::DF2TFourthOrderSection(double B0, double B1, double B2, double B3, double B4,
...
void Biquad2::DF2TBiquad(double B0, double B1, double B2,
...
void BiquadChain::processBiquad(const float * input, float * output, const int stride, const int count, const Biquad2 * coeffs){
...
void BiquadChain::processFourthOrderSections(const float * input, float * output, const int stride, const int count, const Biquad2 * coeffs){
