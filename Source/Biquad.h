...
public:
    ...
    void processBiquad(const float * input, float * output, const int stride, const int count, const Biquad2 * coeffs);
    
    // Extension for fourth order sections
    void processFourthOrderSections(const float * input, float * output, int stride, int count, const Biquad2 * coeffs);
